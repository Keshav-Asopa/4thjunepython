#python program that will detect the particular color-motion of an object using opencv2
import cv2
...
while cap.isOpened():
	...
	cv2.imshow("color_motion",output)
	status, frame = cap.read()

	#selecting particular color from image
